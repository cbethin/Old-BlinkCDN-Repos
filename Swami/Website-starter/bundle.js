    ...
    value: function getDefaultFoundation() {
      ...
      return new _foundation2.default( /** @type {!MDCChipAdapter} */Object.assign({
        ...
        notifyRemoval: function notifyRemoval() {
          return _this3.emit(_constants.strings.REMOVAL_EVENT, { chip: _this3 }, true /* shouldBubble */);
        },
...
var _chips = __webpack_require__(23);

var _axios = __webpack_require__(30);

var _axios2 = _interopRequireDefault(_axios);

var _CORS = __webpack_require__(49);

var _firebaseCode = __webpack_require__(50);

var _charts = __webpack_require__(51);
...
var SERVER_ADDR = "18.221.128.102:8080";
// const CLIENT_ADDR = "155.246.113.15:8000"
var CLIENT_ADDR = "18.216.192.154:8081";

var addresses = ["52.53.177.194:8001", "35.176.239.10:8001", "18.184.225.196:8001", "13.115.224.27:8001"];
// const addresses = ["155.246.45.43:8001", "155.246.45.43:8002", "155.246.45.43:8003", "155.246.45.43:8004"]
var locations = ["United States", "Germany", "United Kingdom", "Japan"];
...
$(document).ready(function () {
  ...
  // Elements
  var sourceChipSet = new _chips.MDCChipSet(document.querySelector('#src-chipset'));
  var dstChipSet = new _chips.MDCChipSet(document.querySelector('#dest-chipset'));
  var nextBtn = document.querySelector('#next-btn');
  var toGraphBtn = document.querySelector('#to-graph-btn');
  var showMapsBtn = document.querySelector('#show-map-btn');
  ...
  nextBtn.addEventListener('click', function () {
    ...
    (0, _CORS.makeCORSRequest)('GET', 'http://' + SERVER_ADDR + '/getSLA?source=' + srcAddr + '&destination=' + dstAddr, function (response) {
      transitionToSelectSla(response);
    });
  });

  toGraphBtn.addEventListener('click', function () {
    (0, _charts.setServiceLevelOnChart)(parseFloat($('.latency-label')[selectedIndex].innerHTML.split(' ')[0]));
    (0, _CORS.makeCORSRequest)('POST', 'http://' + SERVER_ADDR + '/setSLA?sid=0001000100010001&path=' + selectedIndex, transitionToGraphs);
  });

  showMapsBtn.addEventListener('click', function () {
    if (!isMapShowing) {
  ...
  $('.card-container__card').click(function () {
...
function transitionToGraphs(response) {
  ...
  (0, _charts.updateRegionsMap)(usActivation, gmActivation, ukActivation, jpActivation);
  ...
  (0, _firebaseCode.getRealTimeUpdatesTotal)(function (data) {
    // console.log(data);
    (0, _charts.addDataToChart)(data.packetNumber, data.time * 1000.0);
  });

  (0, _firebaseCode.getRealTimeUpdatesFirst)(function (data) {
    // console.log(data);
    (0, _charts.addDataToChartT1T2)(data.packetNumber, data.time * 1000.0);
  });

  (0, _firebaseCode.getRealTimeUpdatesSecond)(function (data) {
    // console.log(data);
    (0, _charts.addDataToChartT2T3)(data.packetNumber, data.time * 1000.0);
  });
  //
...
function sendStopTest() {
  (0, _CORS.makeCORSRequest)('POST', 'http://' + CLIENT_ADDR + '/stoptest', function () {
    console.log();
  });
  (0, _CORS.makeCORSRequest)('POST', 'http://' + CLIENT_ADDR + '/resettest');
}
    ...
    value: function getDefaultFoundation() {
      ...
      return new _foundation2.default( /** @type {!MDCChipSetAdapter} */Object.assign({
        ...
        appendChip: function appendChip(text, leadingIcon, trailingIcon) {
          ...
          chipTextEl.classList.add(_index.MDCChipFoundation.cssClasses.TEXT);
          chipTextEl.appendChild(document.createTextNode(text));

          var chipEl = document.createElement('div');
          chipEl.classList.add(_index.MDCChipFoundation.cssClasses.CHIP);
          if (leadingIcon) {
...
var docRefTotal = firestore.doc("Latency_Data/t1_t3");
var docRefFirst = firestore.doc("Latency_Data/t1_t2");
var docRefSecond = firestore.doc("Latency_Data/t2_t3");
var outputHeader = document.querySelector("#output");

function getRealTimeUpdatesTotal(callback) {
  docRefTotal.get();
  docRefTotal.onSnapshot(function (doc) {
    if (doc && doc.exists) {
      var myData = doc.data();
      // console.log(myData);
      callback(myData);
...
function getRealTimeUpdatesFirst(callback) {
  docRefFirst.get();
  docRefFirst.onSnapshot(function (doc) {
    if (doc && doc.exists) {
      var myData = doc.data();
      // console.log(myData);
      callback(myData);
...
function getRealTimeUpdatesSecond(callback) {
  docRefSecond.get();
  docRefSecond.onSnapshot(function (doc) {
    if (doc && doc.exists) {
      var myData = doc.data();
      // console.log(myData);
      callback(myData);
...
exports.getRealTimeUpdatesTotal = getRealTimeUpdatesTotal;
exports.getRealTimeUpdatesFirst = getRealTimeUpdatesFirst;
exports.getRealTimeUpdatesSecond = getRealTimeUpdatesSecond;
...
function updateRegionsMap(usActivation, germanyActivation, ukActivation, jpActivation) {
  dataMap = google.visualization.arrayToDataTable([['Country', 'Activation'], ['Germany', germanyActivation], ['United States', usActivation], ['United Kingdom', ukActivation], ['Japan', jpActivation]]);
...
exports.addDataToChartT1T2 = addDataToChartT1T2;
exports.addDataToChartT2T3 = addDataToChartT2T3;
exports.updateRegionsMap = updateRegionsMap;
exports.drawChart = drawChart;
exports.setServiceLevelOnChart = setServiceLevelOnChart;
