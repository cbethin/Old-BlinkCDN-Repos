...
$(document).ready(function () {
  ...
  nextBtn.addEventListener('click', function () {
    ...
    (0, _CORS.makeCORSRequest)('GET', 'http://18.221.128.102/getSLA?source=' + srcAddr + '&destination=' + dstAddr, function (response) {
  ...
  toGraphBtn.addEventListener('click', function () {
    ...
    (0, _CORS.makeCORSRequest)('POST', 'http://18.221.128.102/setSLA?sid=0001000100010001&path=' + selectedIndex, transitionToGraphs);
  });
...
function sendStopTest() {
  (0, _CORS.makeCORSRequest)('POST', 'http://18.216.192.154:8081/stoptest', function () {
    console.log();
  });
  (0, _CORS.makeCORSRequest)('POST', 'http://18.221.128.102:8080/resettest');
}
