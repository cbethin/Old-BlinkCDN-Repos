...
$(document).ready(function () {
  ...
  $('.card-container__card').click(function (event) {
...
function transitionToGraphs(response) {
  ...
  (0, _firebaseCode.getRealTimeUpdates)(function (data) {
    // console.log(data);
...
var docRef = firestore.doc("Latency_Data/Latency");
var outputHeader = document.querySelector("#output");

function getRealTimeUpdates(callback) {
  docRef.get();
