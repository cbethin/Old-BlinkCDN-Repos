...
var mySocket = io_client.connect(/*"http://bid.blinkcdn.com"*/"http://localhost:3001");
mySocket.emit('connect service', /*"https://bidserver.blinkcdn.com"*/"https://localhost:4000", "bid");
...
function onEndOfAuction(roomName) {
  ...
  for (bidViewer in rooms[roomName].users) {
    ...
    if (sockets.hasOwnProperty(bidViewer)) {
      ...
      sockets[bidViewer].emit('final bid', bidRoom.highestBid, bidRoom.winner, bidRoom.bidCount, bidRoom.lots[(currentLotNumber+1)%2]);
    }
  }
